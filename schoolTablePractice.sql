...
-- [2000010102, 정약용, 대구광역시 달성구, 010-2222-2222, 학생주임]
-- [2000060201, 김선달, null, 010-2222-3333, null]
INSERT INTO teacher VALUES ('2000010101', '이성계', '부산광역시 해운대구', '010-2222-1111', '일반교사');
INSERT INTO teacher VALUES ('2000010102', '정약용', '대구광역시 달성구', '010-2222-2222', '학생주임');
...
-- 6. 직책이 아직 정해지지않은 교사에 대해서 직책을 '교생'으로 지정
UPDATE teacher SET position = '교생' WHERE position IS NULL;

-- 7. 교실의 좌석수가 25개 이상인 교실을 조회 (교실 번호, 좌석수)만 조회
