...
C.class_code '수업 코드', C.name '수업 이름', T.name '담당교사 이름', T.position '담당교사 직급', SUB.MIN '최저 점수', SUB.MAX '최대 점수'
FROM class C 
...
-- VIEW는 물리적인 저장공간이 존재하지 않기 때문에 INSERT, UPDATE, DELETE 및 INDEX 생성이 불가능
