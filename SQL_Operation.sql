...
-- 거래내역 테이블
-- 거래번호 정수, 거래일자 날짜, 거래구분 가변문자열(10), 내역 장문의 문자열, 금액 실수, 세금 실수, 비고 장문의 문자열
...
INSERT INTO transaction VALUES (2, '2025-01-16', '판매', '영양제', 70000, 7000, '종합비타민');
INSERT INTO transaction VALUES (3, '2025-01-17', '판매', '영양제', 120000, 12000, '종합비타민');INSERT INTO transaction VALUES (4, '2025-01-17', '구매', '책상', 400000, 40000, '4개 구매');
INSERT INTO transaction VALUES (5, '2025-01-17', '구매', '의자', 200000, 20000, '4개 구매');
INSERT INTO transaction VALUES (6, '2025-01-20', '구매', '의약외품', 100000, 10000, '소염진통제');
INSERT INTO transaction VALUES (7, '2025-01-21', '구매', '의약외품', 50000, 5000, '소염진통제');
INSERT INTO transaction VALUES (8, '2025-01-21', '구매', '기타자재', 10000, 1000, '볼펜 및 노트');
INSERT INTO transaction VALUES (9, '2025-01-24', '판매', '의료기기', 8000000, 800000, '휠체어');
INSERT INTO transaction VALUES (10, '2025-01-25', '판매', '의료기기', 50000, 50000, '체온계');
...
-- OR, || : 좌항과 우항이 하나라도 true 이면 true
SELECT * FROM transaction WHERE transaction_date >= '2025-01-20' OR breakdown = '기타자재';
...
SELECT * FROM transaction WHERE transaction_type != '판매';
...
-- 중복제거
-- DISTINCT : SELECT 결과 테이블에서 컬럼 조합의 중복을 제거
